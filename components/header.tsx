...
function AnswerSVG() {
  return (
    <svg id="eVRscnAwi8N1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="currentColor" viewBox="0 0 122.88 122.83" shape-rendering="geometricPrecision"
