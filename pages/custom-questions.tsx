    ...
    <Layout>
      <div className="w-[min(100%,500px)] px-2 py-5 pb-16 flex flex-col gap-8">
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          >
            <svg width="18px" height="18px" viewBox="0 0 24 24" className="shrink-0 fill-purple-500" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
              <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier">
