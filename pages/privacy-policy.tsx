    ...
    return (
        ...
        <main className="bg-gray-50">
            <div className="max-w-2xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                ...
                <div className="prose">
                    <p>At Bond Better, we take your privacy seriously. This Privacy Policy explains how we collect, use, and share the personal information we collect from users of our [Name of Application] application.</p>
                    ...
                    <p>
                        We would only have your personal data as long as you have a Bond Better account, if you delete your account, all your data is also deleted.
                    </p>
